...
ALTER TABLE T_PLAYER
  ADD CONSTRAINT FK9sdl5mre08eax08oau8wfudro FOREIGN KEY (Tournament_id) REFERENCES tournament;
...
ALTER TABLE table_pos
  ADD CONSTRAINT FKqv40g8sy1drhdvgm1o6qr6h3h FOREIGN KEY (SETTINGS_ID) REFERENCES table_settings;
ALTER TABLE table_settings
  ADD CONSTRAINT FKghas75wtmj0dkjkm1hovh2r1j FOREIGN KEY (T_ID) REFERENCES tournament;
...
ALTER TABLE tournament_player
  ADD CONSTRAINT FKrrm3jbmm1fxx5t9t5f8t46ebc FOREIGN KEY (tournament_id) REFERENCES tournament;
