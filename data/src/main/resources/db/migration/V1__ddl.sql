...
create table T_PLAYER (tournaments_id bigint not null, players_id bigint not null, primary key (tournaments_id, players_id));
...
alter table T_PLAYER add constraint FKmlaymevvua011spq8t5ke1tem foreign key (tournaments_id) references tournament;
