...
create table swiss_system_phase (id bigint not null, group_id bigint, primary key (id));
...
create table tournament_player (id bigint generated by default as identity (start with 1), birthday date, email varchar(255), firstname varchar(255) not null, gender varchar(1), last_game_at timestamp, lastname varchar(255) not null, mobilenumber varchar(255), qttr integer, ttr integer, association_id bigint, club_id bigint, tournament_id bigint not null, primary key (id));
