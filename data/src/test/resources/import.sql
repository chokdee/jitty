...
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, OPEN_FOR_MEN, OPEN_FOR_WOMEN, RUNNING, ACTIVE_PHASE) VALUES (2, 2, 'B-Klasse', 0, 1850, TRUE, FALSE, FALSE, -1);
...
INSERT INTO TOURNAMENT_PLAYER (FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID,QTTR, TTR, TOURNAMENT_ID) VALUES ('Timo', 'Boll', 'm', 1, 20,  2499, 2500, 2);
INSERT INTO TOURNAMENT_PLAYER (FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID,QTTR, TTR, TOURNAMENT_ID) VALUES ('Palme', 'Saatkrähe', 'w', 2,1,  1488, 1500, 2);
INSERT INTO TOURNAMENT_PLAYER (FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID,QTTR, TTR, TOURNAMENT_ID) VALUES ('Kartoffel', 'Ohrentaucher', 'm', 3, 2,  1799, 1805, 2);
INSERT INTO TOURNAMENT_PLAYER (FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID,QTTR, TTR, TOURNAMENT_ID) VALUES ('Peter', 'Meier', 'm', 3, 2,  1799, 1805, 2);
