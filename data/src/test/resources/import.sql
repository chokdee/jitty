...
SET TS_ID = 1
WHERE ID = 1;
INSERT INTO TABLE_POS (ID, SETTINGS_ID, COLUMN, ROW) VALUES (1, 1, 0, 0);
INSERT INTO TABLE_POS (ID, SETTINGS_ID, COLUMN, ROW) VALUES (2, 1, 1, 0);
INSERT INTO TABLE_POS (ID, SETTINGS_ID, COLUMN, ROW) VALUES (3, 1, 2, 0);
INSERT INTO TABLE_POS (ID, SETTINGS_ID, COLUMN, ROW) VALUES (4, 1, 3, 0);
INSERT INTO TABLE_POS (ID, SETTINGS_ID, COLUMN, ROW) VALUES (5, 1, 1, 0);
INSERT INTO TABLE_POS (ID, SETTINGS_ID, COLUMN, ROW) VALUES (6, 1, 1, 1);
INSERT INTO TABLE_POS (ID, SETTINGS_ID, COLUMN, ROW) VALUES (7, 1, 1, 2);
INSERT INTO TABLE_POS (ID, SETTINGS_ID, COLUMN, ROW) VALUES (8, 1, 1, 3);

INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, START_TIME, OPEN_FOR_MEN, OPEN_FOR_WOMEN, RUNNING, ACTIVE_PHASE, SYSTEM_TYPE, AGE_GROUP, STATUS) VALUES (1, 2, 'A-Klasse', 1800, 3000, NOW() + INTERVAL '1' HOUR, TRUE, FALSE, FALSE, -1, 1, 'Damen/Herren', 'NOTSTARTED');
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, OPEN_FOR_MEN, OPEN_FOR_WOMEN, RUNNING, ACTIVE_PHASE, SYSTEM_TYPE, AGE_GROUP, STATUS) VALUES (2, 2, 'B-Klasse', 0, 1850, TRUE, FALSE, FALSE, -1, 1, 'Damen/Herren', 'NOTSTARTED');
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, OPEN_FOR_MEN, OPEN_FOR_WOMEN, RUNNING, ACTIVE_PHASE, SYSTEM_TYPE, AGE_GROUP, STATUS) VALUES (3, 2, 'C-Klasse', 0, 1600, TRUE, FALSE, FALSE, -1, 1, 'Damen/Herren', 'NOTSTARTED');
...
UPDATE TOURNAMENT_PLAYER set TOURNAMENT_ID = 2;

INSERT INTO TC_PLAYER (PLAYERS_ID, CLASSES_ID) VALUES (1, 1);
INSERT INTO T_PLAYER (PLAYERS_ID, TOURNAMENT_ID) VALUES (1, 2);
INSERT INTO T_PLAYER (PLAYERS_ID, TOURNAMENT_ID) VALUES (2, 2);
INSERT INTO T_PLAYER (PLAYERS_ID, TOURNAMENT_ID) VALUES (3, 2);
INSERT INTO T_PLAYER (PLAYERS_ID, TOURNAMENT_ID) VALUES (4, 2);