...
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('TV Scheven', (SELECT id
                                                               FROM ASSOCIATION
                                                               WHERE SHORTNAME = 'WTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('TSV Eisenberg', (SELECT id
                                                                  FROM ASSOCIATION
                                                                  WHERE SHORTNAME = 'TTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('SV Grambke Oslebshausen', (SELECT id
                                                                            FROM ASSOCIATION
                                                                            WHERE SHORTNAME = 'FTTB'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('Ahlener SG', (SELECT id
                                                               FROM ASSOCIATION
                                                               WHERE SHORTNAME = 'WTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('FC Ruthe', (SELECT id
                                                             FROM ASSOCIATION
                                                             WHERE SHORTNAME = 'TTVN'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('Herpfer SV 07', (SELECT id
                                                                  FROM ASSOCIATION
                                                                  WHERE SHORTNAME = 'TTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('Switzerland', (SELECT id
                                                                FROM ASSOCIATION
                                                                WHERE SHORTNAME = 'Ausland'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('TTZ Altstadt-Kirkel', (SELECT id
                                                                        FROM ASSOCIATION
                                                                        WHERE SHORTNAME = 'STTB'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('1. FC Bruchsal', (SELECT id
                                                                   FROM ASSOCIATION
                                                                   WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('1. TC Ittersbach', (SELECT id
                                                                     FROM ASSOCIATION
                                                                     WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('1. TTC Ketsch', (SELECT id
                                                                  FROM ASSOCIATION
                                                                  WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('ASV Eppelheim', (SELECT id
                                                                  FROM ASSOCIATION
                                                                  WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('ASV Grünwettersbach', (SELECT id
                                                                        FROM ASSOCIATION
                                                                        WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('BJC Buchen', (SELECT id
                                                               FROM ASSOCIATION
                                                               WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('DJK 1927 Dossenheim', (SELECT id
                                                                        FROM ASSOCIATION
                                                                        WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('DJK Balzfeld', (SELECT id
                                                                 FROM ASSOCIATION
                                                                 WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('DJK Daxlanden', (SELECT id
                                                                  FROM ASSOCIATION
                                                                  WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('DJK Käfertal', (SELECT id
                                                                 FROM ASSOCIATION
                                                                 WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('DJK Mannheim Lindenhof', (SELECT id
                                                                           FROM ASSOCIATION
                                                                           WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('DJK Neckarhausen', (SELECT id
                                                                     FROM ASSOCIATION
                                                                     WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('DJK Ost Karlsruhe', (SELECT id
                                                                      FROM ASSOCIATION
                                                                      WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('DJK Rüppurr', (SELECT id
                                                                FROM ASSOCIATION
                                                                WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('DJK Schönau', (SELECT id
                                                                FROM ASSOCIATION
                                                                WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('DJK St. Hildegard Käfertal Süd', (SELECT id
                                                                                   FROM ASSOCIATION
                                                                                   WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('DJK St. Pius Neuostheim/Neuhermsheim', (SELECT id
                                                                                         FROM ASSOCIATION
                                                                                         WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('DJK Unterbalbach e.V. 1930', (SELECT id
                                                                               FROM ASSOCIATION
                                                                               WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('DJK Mannheim', (SELECT id
                                                                 FROM ASSOCIATION
                                                                 WHERE SHORTNAME = 'BaTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('TTG St. Augustin', (SELECT id
                                                                     FROM ASSOCIATION
                                                                     WHERE SHORTNAME = 'WTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('TTV BW Neudorf', (SELECT id
                                                                   FROM ASSOCIATION
                                                                   WHERE SHORTNAME = 'WTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('TTC Troisdorf', (SELECT id
                                                                  FROM ASSOCIATION
                                                                  WHERE SHORTNAME = 'WTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('1. FC Köln', (SELECT id
                                                               FROM ASSOCIATION
                                                               WHERE SHORTNAME = 'WTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('ESV Troisdorf', (SELECT id
                                                                  FROM ASSOCIATION
                                                                  WHERE SHORTNAME = 'WTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('TSV Seelscheid', (SELECT id
                                                                   FROM ASSOCIATION
                                                                   WHERE SHORTNAME = 'WTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('DJK Eintracht Eitorf', (SELECT id
                                                                         FROM ASSOCIATION
                                                                         WHERE SHORTNAME = 'WTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('TTV Viktoria Bonn', (SELECT id
                                                                      FROM ASSOCIATION
                                                                      WHERE SHORTNAME = 'WTTV'));
INSERT INTO club (NAME, ASSOCIATION_ID) VALUES ('SSV Happerschoß', (SELECT id
                                                                    FROM ASSOCIATION
                                                                    WHERE SHORTNAME = 'WTTV'));
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES (15, 1, 1, NOW(), 'B-Klasse', 1, 4, 21, 19, 2);
...
UPDATE TOURNAMENT_SINGLE_GAME
SET WINNER = -1, CALLED = 0, PLAYED = 0, START_TIME = NULL
WHERE PLAYED = 1;
