...
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, START_TIME, OPEN_FOR_MEN, OPEN_FOR_WOMEN, RUNNING, ACTIVE_PHASE) VALUES (1, 2, 'A-Klasse', 1800, 3000, NOW() + INTERVAL '1' HOUR, TRUE, FALSE, FALSE, -1);
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, OPEN_FOR_MEN, OPEN_FOR_WOMEN, RUNNING, ACTIVE_PHASE) VALUES (2, 2, 'B-Klasse', 0, 1850, TRUE, FALSE, FALSE, 0);
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, OPEN_FOR_MEN, OPEN_FOR_WOMEN, RUNNING, ACTIVE_PHASE) VALUES (3, 2, 'C-Klasse', 0, 1600, TRUE, FALSE, FALSE, -1);
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, OPEN_FOR_MEN, OPEN_FOR_WOMEN, RUNNING, ACTIVE_PHASE) VALUES (4, 2, 'D-Klasse', 0, 1400, TRUE, FALSE, FALSE, -1);
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, START_TIME, OPEN_FOR_MEN, OPEN_FOR_WOMEN, RUNNING, ACTIVE_PHASE) VALUES (5, 2, 'E-Klasse', 0, 1200, NOW(), TRUE, FALSE, FALSE, -1);


INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, START_TIME, OPEN_FOR_MEN, OPEN_FOR_WOMEN, RUNNING, ACTIVE_PHASE) VALUES (6, 3, 'Schweizer System', 0, 3000, NOW(), TRUE, TRUE, FALSE, -1);
...
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR, TOURNAMENT_ID) VALUES (1, 'Timo', 'Boll', 'm', 1, 20, 2499, 2500,2 );
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR, TOURNAMENT_ID) VALUES (2, 'Palme', 'Saatkrähe', 'w', 2, 1, 1488, 1500,2 );
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR, TOURNAMENT_ID) VALUES (3, 'Kartoffel', 'Ohrentaucher', 'm', 3, 2, 1799, 1805,2 );
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR, TOURNAMENT_ID) VALUES (4, 'Noch', 'Keine Anmeldung', 'm', 4, 2, 1155, 1155,2 );
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR, TOURNAMENT_ID) VALUES (5, 'Ma', 'Long', 'm', 5, 2, 2400, 2400,2 );
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR, TOURNAMENT_ID) VALUES (6, 'Fan', 'Zhedong', 'm', 6, 2, 2299, 2299,2 );
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR, TOURNAMENT_ID) VALUES (7, 'Zhang', 'Jike', 'm', 7, 2, 2388, 2388,2 );
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR, TOURNAMENT_ID) VALUES (8, 'Xu', 'Xin', 'm', 8, 2, 2399, 2399,2 );
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR, TOURNAMENT_ID) VALUES (9, 'Nat', 'Melzer', 'w', 8, 2, 2555, 2555,2 );
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR, TOURNAMENT_ID) VALUES (10, 'Jan', 'Mizutani', 'm', 9, 2, 2344, 2344,2 );
...
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR , TOURNAMENT_ID) VALUES (11, 'Karl', 'Müller', 'm', 1, 2, 1755, 1755, 2);
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR , TOURNAMENT_ID) VALUES (12, 'Peter', 'Meier', 'm', 2, 1, 1745, 1745, 2);
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR , TOURNAMENT_ID) VALUES (13, 'Michael', 'Mittermeier', 'm', 3, 3, 1699, 1699, 2);
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR , TOURNAMENT_ID) VALUES (14, 'Hans', 'Rose', 'm', 4, 3, 1700, 1700, 2);
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR , TOURNAMENT_ID) VALUES (15, 'Andreas', 'Michel', 'm', 5, 3, 1720, 1720, 2);
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR , TOURNAMENT_ID) VALUES (16, 'Jürgen', 'Keil', 'm', 6, 3, 1721, 1721, 2);
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR , TOURNAMENT_ID) VALUES (17, 'Manfred', 'Hilde', 'm', 7, 3, 1580, 1580, 2);
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR , TOURNAMENT_ID) VALUES (18, 'Matthias', 'Krut', 'm', 8, 3, 1540, 1540, 2);
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR , TOURNAMENT_ID) VALUES (19, 'Thorsten', 'Knuck', 'm', 9, 3, 1690, 1690, 2);
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR , TOURNAMENT_ID) VALUES (20, 'Erich', 'Kästner', 'm', 10, 3, 1702, 1702, 2);
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR , TOURNAMENT_ID) VALUES (21, 'Frank', 'Pusteblume', 'm', 11, 3, 1703, 1703, 2);
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR , TOURNAMENT_ID) VALUES (22, 'Timo', 'Baum', 'm', 12, 3, 1704, 1704, 2);
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR , TOURNAMENT_ID) VALUES (23, 'Nico', 'Poco', 'm', 13, 3, 1705, 1705, 2);
INSERT INTO TOURNAMENT_PLAYER (ID, FIRSTNAME, LASTNAME, GENDER, CLUB_ID, ASSOCIATION_ID, QTTR, TTR , TOURNAMENT_ID) VALUES (24, 'Stefan', 'Ente', 'm', 14, 3, 1706, 1706, 2);
