...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(1,1, 1, NOW(), 'B-Klasse' , 2, 2, 11, 14, 1);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(3,1, 1, NOW(), 'B-Klasse' , 2, 2, 12, 13, 1);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(4,1, 1, NOW(), 'B-Klasse' , 2, 2, 13, 11, 1);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(5,1, 1, NOW(), 'B-Klasse' , 2, 2, 12, 14, 1);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(6,1, 1, NOW(), 'B-Klasse' , 1, 2, 11, 12, 1);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(7,1, 1, NOW(), 'B-Klasse' , 1, 2, 13, 14, 1);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(8,1, 1, NOW(), 'B-Klasse' , 1, 3, 15, 18, 1);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(9,1, 1, NOW(), 'B-Klasse' , 1, 3, 16, 17, 1);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(10,1, 1, NOW(), 'B-Klasse' , 1, 3, 17, 15, 1);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(11,1, 1, NOW(), 'B-Klasse' , 1, 3, 16, 18, 1);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(12,1, 1, NOW(), 'B-Klasse' , 1, 3, 15, 16, 1);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(13,1, 1, NOW(), 'B-Klasse' , 1, 3, 17, 18, 1);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(14,1, 1, NOW(), 'B-Klasse' , 1, 4, 20, 21, 1);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(15,1, 2, NOW() , 'B-Klasse',1, 4, 21, 19, 1);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(16,1, 1, NOW(), 'B-Klasse' , 1, 4, 19, 20, 1);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(17,1, 1, NOW(), 'B-Klasse' , 1, 5, 23, 24, 1);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(18,0, 1, NULL, 'B-Klasse',  -1, 5, 24, 22, 1);
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME,  WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID, T_ID) VALUES(19,0, 0, NULL, 'B-Klasse', -1, 5, 22, 23, 1);
