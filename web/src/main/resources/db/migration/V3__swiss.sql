...
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, SYSTEM_TYPE, START_TTR, END_TTR, START_TIME, OPEN_FOR_MEN, OPEN_FOR_WOMEN, RUNNING, ACTIVE_PHASE) VALUES (6, 3, 'Schweizer System', 2, 0, 3000, NOW(), TRUE, TRUE, FALSE, -1);
