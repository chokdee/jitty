...
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, START_TIME, OPEN_FOR_MEN, OPEN_FOR_WOMEN, RUNNING) VALUES (1, 2, 'A-Klasse', 1800, 3000, NOW() + INTERVAL '1' HOUR, TRUE, FALSE, FALSE);
...
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, START_TIME, OPEN_FOR_MEN, OPEN_FOR_WOMEN, RUNNING) VALUES (5, 2, 'E-Klasse', 0, 1200, NOW(), TRUE, FALSE, FALSE);

-- one tc has a group
INSERT INTO TOURNAMENT_GROUP(ID, NAME, TC_ID) VALUES (1,'1', 5);
...
INSERT INTO TC_PLAYER (PLAYERS_ID, CLASSES_ID) VALUES (11, 2);
INSERT INTO TC_PLAYER (PLAYERS_ID, CLASSES_ID) VALUES (12, 2);
INSERT INTO TC_PLAYER (PLAYERS_ID, CLASSES_ID) VALUES (13, 2);
INSERT INTO TC_PLAYER (PLAYERS_ID, CLASSES_ID) VALUES (14, 2);
INSERT INTO TC_PLAYER (PLAYERS_ID, CLASSES_ID) VALUES (15, 2);
INSERT INTO TC_PLAYER (PLAYERS_ID, CLASSES_ID) VALUES (16, 2);
INSERT INTO TC_PLAYER (PLAYERS_ID, CLASSES_ID) VALUES (17, 2);
INSERT INTO TC_PLAYER (PLAYERS_ID, CLASSES_ID) VALUES (18, 2);
INSERT INTO TC_PLAYER (PLAYERS_ID, CLASSES_ID) VALUES (19, 2);
INSERT INTO TC_PLAYER (PLAYERS_ID, CLASSES_ID) VALUES (20, 2);
INSERT INTO TC_PLAYER (PLAYERS_ID, CLASSES_ID) VALUES (21, 2);
INSERT INTO TC_PLAYER (PLAYERS_ID, CLASSES_ID) VALUES (22, 2);
INSERT INTO TC_PLAYER (PLAYERS_ID, CLASSES_ID) VALUES (23, 2);
INSERT INTO TC_PLAYER (PLAYERS_ID, CLASSES_ID) VALUES (24, 2);

INSERT INTO TOURNAMENT_GROUP (ID,NAME, TC_ID) VALUES (2, 'A', 2);
INSERT INTO TOURNAMENT_GROUP (ID,NAME, TC_ID) VALUES (3, 'B', 2);
INSERT INTO TOURNAMENT_GROUP (ID,NAME, TC_ID) VALUES (4, 'C', 2);
INSERT INTO TOURNAMENT_GROUP (ID,NAME, TC_ID) VALUES (5, 'D', 2);

INSERT INTO TG_PLAYER (TOURNAMENT_GROUP_ID, PLAYERS_ID) VALUES (2, 11);
INSERT INTO TG_PLAYER (TOURNAMENT_GROUP_ID, PLAYERS_ID) VALUES (2, 12);
INSERT INTO TG_PLAYER (TOURNAMENT_GROUP_ID, PLAYERS_ID) VALUES (2, 13);
INSERT INTO TG_PLAYER (TOURNAMENT_GROUP_ID, PLAYERS_ID) VALUES (2, 14);
INSERT INTO TG_PLAYER (TOURNAMENT_GROUP_ID, PLAYERS_ID) VALUES (3, 15);
INSERT INTO TG_PLAYER (TOURNAMENT_GROUP_ID, PLAYERS_ID) VALUES (3, 16);
INSERT INTO TG_PLAYER (TOURNAMENT_GROUP_ID, PLAYERS_ID) VALUES (3, 17);
INSERT INTO TG_PLAYER (TOURNAMENT_GROUP_ID, PLAYERS_ID) VALUES (3, 18);
INSERT INTO TG_PLAYER (TOURNAMENT_GROUP_ID, PLAYERS_ID) VALUES (4, 19);
INSERT INTO TG_PLAYER (TOURNAMENT_GROUP_ID, PLAYERS_ID) VALUES (4, 20);
INSERT INTO TG_PLAYER (TOURNAMENT_GROUP_ID, PLAYERS_ID) VALUES (4, 21);
INSERT INTO TG_PLAYER (TOURNAMENT_GROUP_ID, PLAYERS_ID) VALUES (5, 22);
INSERT INTO TG_PLAYER (TOURNAMENT_GROUP_ID, PLAYERS_ID) VALUES (5, 23);
INSERT INTO TG_PLAYER (TOURNAMENT_GROUP_ID, PLAYERS_ID) VALUES (5, 24);

UPDATE TOURNAMENT_CLASS SET START_TIME=NOW(), RUNNING=1 WHERE ID = 2;

INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(1,1, 1, NOW(), 'B-Klasse' , 2, 2, 2, 11, 14);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(3,1, 1, NOW(), 'B-Klasse' , 2, 2, 2, 12, 13);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(4,1, 1, NOW(), 'B-Klasse' , 2, 2, 2, 13, 11);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(5,1, 1, NOW(), 'B-Klasse' , 2, 2, 2, 12, 14);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(6,1, 1, NOW(), 'B-Klasse' , 2, 1, 2, 11, 12);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(7,1, 1, NOW(), 'B-Klasse' , 2, 1, 2, 13, 14);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(8,1, 1, NOW(), 'B-Klasse' , 2, 1, 3, 15, 18);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(9,1, 1, NOW(), 'B-Klasse' , 2, 1, 3, 16, 17);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(10,1, 1, NOW(), 'B-Klasse' , 2, 1, 3, 17, 15);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(11,1, 1, NOW(), 'B-Klasse' , 2, 1, 3, 16, 18);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(12,1, 1, NOW(), 'B-Klasse' , 2, 1, 3, 15, 16);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(13,1, 1, NOW(), 'B-Klasse' , 2, 1, 3, 17, 18);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(14,1, 1, NOW(), 'B-Klasse' , 2, 1, 4, 20, 21);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(15,1, 2, NOW() , 'B-Klasse',2, 1, 4, 21, 19);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(16,1, 1, NOW(), 'B-Klasse' , 2, 1, 4, 19, 20);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(17,1, 1, NOW(), 'B-Klasse' , 2, 1, 5, 23, 24);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(18,0, 1, NULL, 'B-Klasse', 2, -1, 5, 24, 22);
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, TOURNAMENT_CLASS_NAME, TC_ID, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(19,0, 0, NULL, 'B-Klasse', 2, -1, 5, 22, 23);
