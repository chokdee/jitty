...
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, OPEN_FOR_MEN, OPEN_FOR_WOMEN) VALUES (1, 2, 'A-Klasse', 1800, 3000, TRUE, FALSE);
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, OPEN_FOR_MEN, OPEN_FOR_WOMEN) VALUES (2, 2, 'B-Klasse', 0, 1850, TRUE, FALSE);
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, OPEN_FOR_MEN, OPEN_FOR_WOMEN) VALUES (3, 2, 'C-Klasse', 0, 1600, TRUE, FALSE);
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, OPEN_FOR_MEN, OPEN_FOR_WOMEN) VALUES (4, 2, 'D-Klasse', 0, 1400, TRUE, FALSE);
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, OPEN_FOR_MEN, OPEN_FOR_WOMEN) VALUES (5, 2, 'E-Klasse', 0, 1200, TRUE, FALSE);
