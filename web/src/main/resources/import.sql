...
INSERT INTO TOURNAMENT_CLASS (ID, T_ID, NAME, START_TTR, END_TTR, START_TIME, OPEN_FOR_MEN, OPEN_FOR_WOMEN, RUNNING) VALUES (5, 2, 'E-Klasse', 0, 1200, NOW(), TRUE, FALSE, TRUE);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(1,1, 1, NOW(), 2, 2, 11, 14);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(2,1, 1, NOW(), 2, 2, 11, 14);
INSERT INTO GAME_SET (ID, POINTS1, POINTS2) VALUES (6,8,11);
INSERT INTO TOURNAMENT_SINGLE_GAME_SET ( TOURNAMENT_SINGLE_GAME_ID, SETS_ID) VALUES (2,6);
INSERT INTO GAME_SET (ID, POINTS1, POINTS2) VALUES (7,7,11);
INSERT INTO TOURNAMENT_SINGLE_GAME_SET ( TOURNAMENT_SINGLE_GAME_ID, SETS_ID) VALUES (2,7);
INSERT INTO GAME_SET (ID, POINTS1, POINTS2) VALUES (8,2,11);
INSERT INTO TOURNAMENT_SINGLE_GAME_SET ( TOURNAMENT_SINGLE_GAME_ID, SETS_ID) VALUES (2,8);
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(3,1, 1, NOW(), 2, 2, 12, 13);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(4,1, 1, NOW(), 2, 2, 13, 11);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(5,1, 1, NOW(), 2, 2, 12, 14);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(6,1, 1, NOW(), 1, 2, 11, 12);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(7,1, 1, NOW(), 1, 2, 13, 14);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(8,1, 1, NOW(), 1, 3, 15, 18);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(9,1, 1, NOW(), 1, 3, 16, 17);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(10,1, 1, NOW(), 1, 3, 17, 15);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(11,1, 1, NOW(), 1, 3, 16, 18);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(12,1, 1, NOW(), 1, 3, 15, 16);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(13,1, 1, NOW(), 1, 3, 17, 18);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(14,1, 1, NOW(), 1, 4, 20, 21);
...
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(15,0, 0, NOW(), -1, 4, 21, 19);
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(16,0, 0, NOW(), -1, 4, 19, 20);
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(17,0, 0, NOW(), -1, 5, 23, 24);
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(18,0, 0, NOW(), -1, 5, 24, 22);
INSERT INTO TOURNAMENT_SINGLE_GAME (ID, CALLED, PLAYED, START_TIME, WINNER, GROUP_ID, PLAYER1_ID, PLAYER2_ID) VALUES(19,0, 0, NOW(), -1, 5, 22, 23);
